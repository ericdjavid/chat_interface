...
export default function Chat() {
  ...
  const [conversation, setConversation] = useState<Message[]>([
    { message: "Hey I'm a new applicant", type: "bot" }
  ]);
  ...
  const randomResponses = [
    ...
    "Can you explain the role in more detail?",
    "What are the next steps in the application process?",
    "I have experience in that area. Would you like to know more?",
    "That sounds challenging. How does the team handle such situations?",
    "I'm curious about the growth opportunities in this position.",
  ...
  const sendMessage = () => {
    if (userInput) {
      ...
      // Simulate a random bot response
      setTimeout(() => {
        const randomResponse = randomResponses[Math.floor(Math.random() * randomResponses.length)];
        addMessage({ message: randomResponse, type: "bot" });
